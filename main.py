...
def setGUITrackbars(gaussianSize, gaussianSigma, canny1, canny2, accumulator, minDist, param1, param2, minRadius,
    ...
    cv2.createTrackbar("Gaussian Blur - Size", "BIOM_Zadanie_1", gaussianSize, 100, nothing)
    cv2.createTrackbar("Gaussian Blur - Sigma", "BIOM_Zadanie_1", gaussianSigma, 100, nothing)
    cv2.createTrackbar("Canny1", "BIOM_Zadanie_1", canny1, 100, nothing)
    cv2.createTrackbar("Canny2", "BIOM_Zadanie_1", canny2, 200, nothing)
    cv2.createTrackbar("Accumulator", "BIOM_Zadanie_1", accumulator, 50, nothing)
    cv2.createTrackbar("minDist", "BIOM_Zadanie_1", minDist, 50, nothing)
    cv2.createTrackbar("param1", "BIOM_Zadanie_1", param1, 150, nothing)
    cv2.createTrackbar("param2", "BIOM_Zadanie_1", param2, 100, nothing)
    cv2.createTrackbar("minRadius", "BIOM_Zadanie_1", minRadius, 100, nothing)
    cv2.createTrackbar("maxRadius", "BIOM_Zadanie_1", maxRadius, 300, nothing)
    cv2.createTrackbar("Acceptance", "BIOM_Zadanie_1", acceptance, 100, nothing)
...
cv2.namedWindow('BIOM_Zadanie_1', cv2.WINDOW_AUTOSIZE)
key = cv2.waitKey(0)
...
while True:
    ...
    gcSize = cv2.getTrackbarPos("Gaussian Blur - Size", "BIOM_Zadanie_1")
    gcSigma = cv2.getTrackbarPos("Gaussian Blur - Sigma", "BIOM_Zadanie_1")
    threshold1 = cv2.getTrackbarPos("Canny1", "BIOM_Zadanie_1")
    threshold2 = cv2.getTrackbarPos("Canny2", "BIOM_Zadanie_1")
    accumulator = cv2.getTrackbarPos("Accumulator", "BIOM_Zadanie_1")
    minDist = cv2.getTrackbarPos("minDist", "BIOM_Zadanie_1")
    param1 = cv2.getTrackbarPos("param1", "BIOM_Zadanie_1")
    param2 = cv2.getTrackbarPos("param2", "BIOM_Zadanie_1")
    minRadius = cv2.getTrackbarPos("minRadius", "BIOM_Zadanie_1")
    maxRadius = cv2.getTrackbarPos("maxRadius", "BIOM_Zadanie_1")
    acceptance = cv2.getTrackbarPos("Acceptance", "BIOM_Zadanie_1")
    ...
    cv2.imshow("BIOM_Zadanie_1.2", imgAfterCvtColor)
    cv2.imshow("BIOM_Zadanie_1.3", imgAfterCanny)
    #cv2.imshow("BIOM_Zadanie_1.5", ukazka)

    # BONUS: Applying the mask outside of duhovka
    # if numberOfDuhovkas == 1:
    #     cv2.imshow("BIOM_Zadania_1.4", maskOutsideOfCircle(imgAfterCvtColor, arrayOfDuhovkas[0]))
